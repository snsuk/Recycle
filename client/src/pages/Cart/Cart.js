                ...
                <div className="w-full overflow-x-auto">
                    <table className="w-full">
                        ...
                        <tr className="text-md font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
                            <th className="px-4 py-3 w-96">Название</th>
                        ...
                        <tr className="text-gray-700">
                            ...
                            <td className="px-4 py-3 text-ms font-semibold border text-center">
                                <button onClick={() => dispatch(clearCart())}
                                        className="px-6 py-2 text-white font-semibold bg-red-600 rounded-xl">Очистить
                                </button>
                            </td>
                            <td className="px-4 py-3 text-xs border">
                                <span
                                    className="px-2 py-1 font-semibold text-lg leading-tight text-green-700 bg-green-100 rounded-sm">
                                    Итого: &nbsp;
                                    {
