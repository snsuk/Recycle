                 ...
                 className="fixed z-50 top-0 right-0 pb-12 w-80 bg-gray-900 rounded-b-2xl">
                {
                    !searchInput && <>
                        ...
                        ? <div className="mt-12 mb-6 flex justify-around">
                          <Link className="bg-gray-300 px-3 py-1 rounded-md font-semibold" to="/signup">Регистрация</Link>
                          <Link className="bg-gray-300 px-3 py-1 rounded-md font-semibold" to="/signin">Войти</Link>
                        </div>
                            : <div className="mt-12 mb-6 text-center">
                                <button onClick={logoutClick} className="bg-gray-300 px-3 py-1 rounded-md font-semibold">Выйти
                                </button>
                            </div>
                        }
                        ...
                        {/*           className="px-3 py-2 font-medium text-center" type="text"/>*/}
                        {/*</div>*/}
                    </>
                }
                <div className="text-2xl text-white text-center">Search:</div>
                <div className="text-center">
                    <input onChange={(e) => setSearchInput(e.target.value)} className="px-3 py-2 font-medium text-center"
                           type="text"/>
                </div>
            </div>
        </div>
